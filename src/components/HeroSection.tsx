      ...
      <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-8">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Coupe du Monde 2030
            <span className="block text-moroccan-sand">Au Cœur du Maroc</span>
          </h1>
          <p className="text-lg md:text-xl opacity-90 mb-8">
            Préparez-vous pour l'événement sportif le plus attendu. 
            Découvrez les stades, achetez des billets et explorez le Maroc.
          </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
          <div className="text-center bg-white/10 backdrop-blur-sm rounded-xl p-4">
            ...
            <div className="text-sm opacity-80">Équipes</div>
          </div>
          <div className="text-center bg-white/10 backdrop-blur-sm rounded-xl p-4">
            <div className="text-4xl font-bold mb-1">6</div>
            <div className="text-sm opacity-80">Villes hôtes</div>
          </div>
          <div className="text-center bg-white/10 backdrop-blur-sm rounded-xl p-4">
            <div className="text-4xl font-bold mb-1">104</div>
            <div className="text-sm opacity-80">Matchs</div>
          </div>
          <div className="text-center bg-white/10 backdrop-blur-sm rounded-xl p-4">
            <div className="text-4xl font-bold mb-1">1M+</div>
            <div className="text-sm opacity-80">Billets</div>
          </div>
        </div>
      </div>
