...
import { Cities, TourismHero, TourismCategories, TourismSpots, TourismSectionTitles, TourismCulturalExperiences } from "@/helpers/Helper";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-white dark:bg-moroccan-dark">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold mb-10">{TourismSectionTitles.hostCities}</h2>
        ...
        <section className="py-16 bg-gray-50 dark:bg-moroccan-dark/80">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">{TourismSectionTitles.culturalExperiences}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {TourismCulturalExperiences.map((experience, idx) => (
                <div key={idx} className="card-morocco p-4 flex flex-col h-full">
                  ...
                  <Button className="w-full bg-moroccan-green hover:bg-opacity-90">{experience.button}</Button>
                </div>
              ))}
            </div>
          </div>
